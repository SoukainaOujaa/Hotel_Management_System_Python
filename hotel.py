...
def mainroot():
	...
	label = Label(top_frame,height=70,width=1080)
	...
	b1 = Button(sl_frame,text='b1',bg='white',width=180,command=rooms)

	b1.place(x=180,y=0)

	b2 = Button(sl_frame,text='b2',bg='white',width=180,command=hotel_status)

	b2.place(x=0,y=0)

	b3 = Button(sl_frame,text='b2',bg='white',width=180,command=staff)

	b3.place(x=180*4,y=0)

	b4 = Button(sl_frame,text='b2',bg='white',width=180,command = payments)

	b4.place(x=180*3,y=0)

	b5 = Button(sl_frame,text='b2',bg='white',width=180,height=100,command=login)

	b5.place(x=180*5,y=0)

	b6 = Button(sl_frame,text='b2',bg='white',width=180,height=100,command=reserve)
